...
# This is a simplified version of 16S-Taxa-Phylo-Pipeline for inditification the full length 16S seq in .fasta format.
# Edited 202104 by Wenlong Zuo https://github.com/JacobZuo/
...
fastaFileList = InDir
## blastn
RunBlastn(fastaFileList, db, threads, OutDir)
## blast tsv parse
pairsOut = parseIndex(os.path.join(OutDir, "blast"), OutDir)
pairsOut.to_csv(os.path.join(OutDir, "Out.csv"))
